...
final class DownloadsController
{
     ...
     * URL: index.php?action=downloadLote&lote_id=XYZ
     */
    public function actionDownloadLote(): void
    {
    ...
    /**
     * Download de um caderno específico como ZIP
     * URL: index.php?action=downloadCaderno&lote_id=XYZ&caderno_hash=ABC
     */
