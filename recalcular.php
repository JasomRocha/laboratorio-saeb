...
<div class="ui segment">
    ...
    <?php if ($rabbitOk): ?>
        <div class="ui positive message">
            <div class="header">Reprocessamento iniciado.</div>
            <p>O lote foi reenviado para a fila de correção e está com status <strong>em_processamento</strong>.</p>
        </div>
    <?php else: ?>
